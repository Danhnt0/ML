...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Temcur.setGeometry(QtCore.QRect(50, 180, 90, 81))
...
ui.weatertext.setText(str(weather_de))
